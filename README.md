...
<modules>
        <module version="0.1">com.openamplify.appsflyer</module>
</modules>
...
For example,
        ...
        var my_module = require('com.openamplify.appsflyer');
        my_module.foo();
...
To create a module, create a file named com.openamplify.appsflyer.js under the assets folder.
