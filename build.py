...
module_defaults = {
	'description':'appsflyer titanium module',
	'author': 'OpenAmplify LLC',
	'license' : 'MIT',
	'copyright' : 'Copyright (c) %s by OpenAmplify LLC' % str(date.today().year),
}
...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.openamplify.appsflyer.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','ComOpenamplifyAppsflyerModuleAssets.m')
